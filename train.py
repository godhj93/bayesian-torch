...
def main(args):
    ...
    log_path = 'runs/{}/{}/{}/bs{}_lr{}_mc{}_temp_{}_ep{}_kd_{}_moped_{}_{}'.format(args.data, args.model, args.type, args.bs, args.lr, args.mc_runs, args.t, args.epochs, args.distill, args.moped, date)
    ...
    if args.distill:
        ...
        model = distill(dnn_model, model, steps = 10000, device = device, writer = writer)
